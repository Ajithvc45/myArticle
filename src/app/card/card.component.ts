...
export class CardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.contentService.getContent(this.articleId).subscribe((res) => {
      this.articleArr = res;
      // this.articleArr
      console.log('article', this.articleArr.sort((x:any,y:any) => y-x));
    });
  }
  ...
  openDialog(data:any): void {
    ...
    const dialogRef = this.dialog.open(DialogOverviewExampleDialog, {
      data: {id: this.articleObj.id ,author: this.articleObj.author, title: this.articleObj.title, date: this.articleObj.date, content: this.articleObj.content},
    });
